...
<div id="editDiv">
    <form class="editForm" action="updatePWD" method="post">
        <table>
            <tr>
                <td><span id="right"><strong>读者(Admin): </strong></span><input class="form-control" type="text" name="name" value="${name}"/></td>
            </tr>

            <tr>
                <td><span id="right"><strong>请输入旧密码:  </strong></span><input class="form-control" type="password" name="oldPWD" /></td>
            </tr>
            <tr>
                <td><span id="right"><strong>请输入新密码: </strong></span><input class="form-control" type="password" name="newPWD" /></td>
            </tr>
        </table>
